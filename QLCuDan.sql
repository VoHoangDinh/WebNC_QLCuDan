...
CREATE TABLE TheBaoHiem (
    ...
    MaSoThe VARCHAR(50) NOT NULL,       -- Mã số in trên thẻ
    NgayDangKy DATE NOT NULL,
    NgayHetHan DATE NOT NULL,
    NoiDangKyKCB NVARCHAR(200),         -- Nơi đăng ký Khám chữa bệnh ban đầu
    GhiChu NVARCHAR(255),               -- Ghi chú thêm (nếu có)
    
    -- Khóa ngoại liên kết với Cư Dân (Một cư dân có thể có thẻ hoặc không)
...
GO
INSERT INTO TheBaoHiem (MaSoThe, NgayDangKy, NgayHetHan, NoiDangKyKCB, MaCuDan)
VALUES ('DN4010123456789', '2023-01-01', '2024-01-01', N'Bệnh viện Đa khoa Đống Đa', 1);

-- Thêm thẻ cho Cư dân ID 2 (Trần Thị Mai)
INSERT INTO TheBaoHiem (MaSoThe, NgayDangKy, NgayHetHan, NoiDangKyKCB, MaCuDan)
VALUES ('GD4010987654321', '2023-06-01', '2025-06-01', N'Bệnh viện Bạch Mai', 2);

-- Thêm thẻ cho Cư dân ID 4 (Lê Văn Hùng - Chủ hộ 2) - Thẻ sắp hết hạn để test tính năng cảnh báo
INSERT INTO TheBaoHiem (MaSoThe, NgayDangKy, NgayHetHan, NoiDangKyKCB, MaCuDan)
VALUES ('DN4790555555555', '2022-12-01', '2023-12-01', N'Bệnh viện Quân Y 103', 4);
